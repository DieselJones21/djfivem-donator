...
Catalog = {
    ...
    extras = {
        ...
        },
        {
            ...
            description = 'Bandages, first aid, and a painkiller bundle.',
            price = 90,
            extras = {
        ...
        },
        {
            ...
            description = 'A stack of advanced lockpicks for when plans change.',
            price = 80,
            extras = {
                { item = 'advancedlockpick', count = 8 },
            },
        },
        {
            id = 'ext_repair',
        ...
        },
        {
            ...
            description = 'Armor, meds, lockpicks, and a pistol — one-time bundle.',
            price = 350,
            unique = true,
            extras = {
                { item = 'armour', count = 3 },
                { item = 'bandage', count = 10 },
                { item = 'advancedlockpick', count = 4 },
